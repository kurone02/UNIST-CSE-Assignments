...
Mem(HashMap(LocVal(3) -> IntVal(13), LocVal(5) -> IntVal(9), LocVal(1) -> IntVal(10), LocVal(4) -> IntVal(21), LocVal(2) -> IntVal(13)),6))
  ...
  ,(HashMap[Var,LocVal](Var("x") -> LocVal(1), Var("y") -> LocVal(2)),
  Mem(HashMap(LocVal(1) -> IntVal(0), LocVal(2) -> RecordVal(Var("a"), LocVal(3), RecordVal(Var("b"), LocVal(1), EmptyRecordVal)), LocVal(3) -> LocVal(4), LocVal(4) -> ProcVal(List(Var("x")), Const(0), HashMap[Var, LocVal](Var("z") -> LocVal(5))), LocVal(5) -> IntVal(0), LocVal(6) -> LocVal(7), LocVal(7) -> LocVal(6)),8),
  Mem(HashMap[LocVal,Val](LocVal(1) -> IntVal(0), LocVal(2) -> RecordVal(Var("a"), LocVal(3), RecordVal(Var("b"), LocVal(1), EmptyRecordVal)), LocVal(3) -> LocVal(4), LocVal(4) -> ProcVal(List(Var("x")), Const(0), HashMap[Var, LocVal](Var("z") -> LocVal(5))), LocVal(5) -> IntVal(0)),8))
)
