...
private:
	...
	Node* FindByValue(const int value, const bool isLast = false);

	// Returns the pointer that points to the previous of the first node having the value.
	Node* PrevFindByValue(const int value, const bool isLast = false);
...
template <typename Type>
typename LinkedList<Type>::Node* LinkedList<Type>::FindByValue(const int value, const bool isLast)
{
	Node *current = head;
	Node *res = NULL;
	while(current != NULL)
...
template <typename Type>
typename LinkedList<Type>::Node* LinkedList<Type>::PrevFindByValue(const int value, const bool isLast)
{
	Node *current = head;
	Node *res = NULL;
	while(current != NULL)
