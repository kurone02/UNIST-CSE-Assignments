...
template <typename Type>
typename LinkedList<Type>::Node* LinkedList<Type>::FindByValue(const Type value)
{
	Node *current = head;
	Node *res = NULL;
	while(current != NULL)
...
template <typename Type>
typename LinkedList<Type>::Node* LinkedList<Type>::PrevFindByValue(const Type value)
{
