...
int main()
{
	...
	FlatHash fh_new(LINEAR_PROBING, 0.8);
	std::cout << fh_new.insert(3)    << std::endl;
	fh_new.print();
	std::cout << fh_new.insert(7)    << std::endl;
	fh_new.print();
	std::cout << fh_new.insert(1003) << std::endl;
	fh_new.print();
	std::cout << fh_new.insert(2003) << std::endl;
	fh_new.print();
	std::cout << fh_new.insert(2006) << std::endl;
	fh_new.print();
	std::cout << fh_new.insert(3006) << std::endl;
	fh_new.print();
	std::cout << fh_new.remove(2003) << std::endl;
	fh_new.print();
	std::cout << fh_new.remove(7) << std::endl;
	fh_new.print();
	...
	for (int i = 500; i < 3300; i++){    // UPDATED 191111
		nf.insert(i);
	}
	std::cout << nf.insert(365) << std::endl;
	std::cout << nf.search(365) << std::endl;
	std::cout << nf.search(9034) << std::endl;
	std::cout << nf.getTableSize() << std::endl;
	std::cout << nf.getFilterSize() << std::endl;
